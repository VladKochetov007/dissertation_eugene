...
\subsection{The Vibing Spectrum}

The $\mathcal{O} \to \Pi$ mapping defines a continuum:
\begin{equation*}
    \underbrace{\text{Full articulation}}_{\substack{L_{\text{self}} \approx 0 \\
    \text{Pearl Level 3}}}
    \quad\longleftrightarrow\quad
    \underbrace{\text{Pure vibing}}_{\substack{L_{\text{self}} \approx V_{\max} \\
    \text{Pearl Level 1}}}
\end{equation*}
The cooperative PG creates evolutionary pressure toward articulability:
agents that can communicate are more valuable coalition partners.
This formalizes the $\Omega$-framework's claim that multi-agent
interaction drives agents up Pearl's causal hierarchy.
